...
use BrianFaust\Repository\Contracts\RepositoryCriteriaInterface;
use BrianFaust\Repository\Contracts\RepositoryInterface;
use BrianFaust\Repository\Events\RepositoryEntityCreated;
use BrianFaust\Repository\Events\RepositoryEntityDeleted;
use BrianFaust\Repository\Events\RepositoryEntityUpdated;
...
abstract class BaseRepository implements RepositoryInterface, RepositoryCriteriaInterface
{
    ...
    /**
     * Specify Validator class name of BrianFaust\Validator\Contracts\ValidatorInterface.
     *
     * @throws Exception
     */
    ...
    public function makeModel()
    {
        ...
        if (!$model instanceof Model) {
            throw new RepositoryException("Class {$this->model()} must be an instance of Illuminate\\Database\\Model");
        }
    ...
    public function makePresenter($presenter = null)
    {
        ...
        if (!is_null($presenter)) {
            ...
            if (!$this->presenter instanceof PresenterInterface) {
                throw new RepositoryException("Class {$presenter} must be an instance of BrianFaust\\Repository\\Contracts\\PresenterInterface");
            }
    ...
    public function makeValidator($validator = null)
    {
        ...
        if (!is_null($validator)) {
            ...
            if (!$this->validator instanceof ValidatorInterface) {
                throw new RepositoryException("Class {$validator} must be an instance of BrianFaust\\Validator\\Contracts\\ValidatorInterface");
            }
     ...
     * @param $criteria
     *
     * @throws \BrianFaust\Repository\Exceptions\RepositoryException
     *
     * @return $this
     */
    public function pushCriteria($criteria)
    {
        ...
        if (!$criteria instanceof CriteriaInterface) {
            throw new RepositoryException('Class '.get_class($criteria).' must be an instance of BrianFaust\\Repository\\Contracts\\CriteriaInterface');
        }
